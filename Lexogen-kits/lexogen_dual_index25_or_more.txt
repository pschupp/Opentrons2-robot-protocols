...
def run(protocol):
    ...
    mastermix_transfer(p20, tips_1, ss2e2_mm, mag_sample, 5.5)
    ...
    # SPRI_clean_up_a(p300, TIPS_1, mag_sample, 16.5, xdirss, mag_bead1, mag_bead1_volume)
    ...
    SPRI_clean_up_b(p300, [TIPS_2, TIPS_3], mag_sample, waste, xdirss, ethanol)
    # protocol.delay(minutes= 4)
    magdeck.disengage()
    
    SPRI_clean_up_c(p300, TIPS_4, mag_sample, xdirss, elution_buffer, 40.5)
    protocol.delay(minutes=2)

    SPRI_clean_up_d(p300, TIPS_5, mag_sample, xdirss, ps, 56.5)
    ...
    SPRI_clean_up_e(
        p300, [TIPS_6, TIPS_7, TIPS_8, TIPS_1], mag_sample, waste, xdirss, ethanol
    )
    ...
    SPRI_clean_up_c(p300, TIPS_2, mag_sample, xdirss, elution_buffer, 20.5)
    protocol.delay(minutes=2)
    magdeck.engage(magheight)
    protocol.delay(minutes=5)
    
    SPRI_clean_up_f(p20, tips_3, mag_sample, 17.5, warm_sample, xdirss)
    ...
    mastermix_transfer(p20, tips_4, pcre3_mm, warm_sample, 8.5)
    ...
    magdeck.disengage()
    SPRI_clean_up_a(
        p300, TIPS_3, mag_sample, 35.5, xdirss, mag_bead2, mag_bead2_volume
    )
    ...
    SPRI_clean_up_b(p300, [TIPS_4, TIPS_5], mag_sample, waste, xdirss, ethanol)
    #protocol.delay(minutes= 4)
    magdeck.disengage()

    SPRI_clean_up_c(p300, TIPS_6, mag_sample, xdirss, elution_buffer, 30.5)
    protocol.delay(minutes=2.0)

    SPRI_clean_up_d(p300, TIPS_7, mag_sample, xdirss, ps, 30.5)
    ...
    SPRI_clean_up_e(
        p300,
        [TIPS_8, TIPS_1, TIPS_2, TIPS_3],
        mag_sample,
        waste,
        xdirss,
        ethanol,
    )
    protocol.delay(minutes= 1.5)  # let beads dry
    magdeck.disengage()

    # tempdeck.set_temperature(4)

    SPRI_clean_up_c(p300, TIPS_4, mag_sample, xdirss, elution_buffer, 20.5)
    protocol.delay(minutes=2)
    magdeck.engage(magheight)
    protocol.delay(minutes=5)

    SPRI_clean_up_f(p20, tips_1, mag_sample, 17.5, warm_sample, xdirss)
